              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {[
                    ...
                    { id: 'plan-starter', name: 'Starter', price: '₪300/شهرياً', desc: 'حتى 15 طاولة' },
                    { id: 'plan-pro', name: 'Pro Hospitality', price: '₪550/شهرياً', desc: 'حتى 50 طاولة + تحليلات', popular: true },
                    { id: 'plan-enterprise', name: 'Enterprise', price: '₪850/شهرياً', desc: 'طاولات وفروع غير محدودة' },
                  ].map((p) => (
                    <button
                      key={p.id}
                      type="button"
