...
const PLANS: PlanDef[] = [
  {
    ...
    features: [
      ...
      'منيو رقمي فاخر بصور وأصناف غير محدودة الأوصاف',
      'طلب مباشر بدون تسجيل حساب من الطاولة',
      'زر استدعاء النادل مع تحديد سبب الطلب',
      'كاشير أساسي والدفع عند الاستلام/الكاشير',
      'تقارير مبيعات يومية ودعم فني عبر واتساب',
    ],
    details: [
      {
        title: 'حدود السعة والحسابات',
        items: [
          '15 طاولة برموز QR فريدة وآمنة لكل طاولة',
          '6 أقسام رئيسية للمنيو و 35 صنفاً نشطاً',
          'حساب مدير واحد + طاقم خدمة بدون حد (دخول PIN)',
        ],
      },
      {
        title: 'المنيو الرقمي وتجربة الزبون',
        items: [
          'قائمة طعام تفاعلية فاخرة بصور وأوصاف ومكونات (عربي/إنجليزي)',
          'بحث فوري عن الأطباق والمكونات المسببة للحساسية',
          'خيارات تخصيص الوجبة: إضافات، أحجام، استبعاد مكونات، وملاحظات الشيف',
          'جولات طلب متعددة تُجمَّع تلقائياً في فاتورة واحدة للزبون',
        ],
      },
      {
        title: 'الطلب والضيافة من الطاولة',
        items: [
          'مسح QR والطلب الفوري دون الحاجة لتنزيل تطبيق أو تسجيل حساب',
          'تتبع مباشر لحالة الطلب (قيد التحضير → جاهز → تم التقديم)',
          'زر استدعاء النادل بضغطة زر مع اختيار السبب (طلب مساعدة/طلب الفاتورة)',
        ],
      },
      {
        title: 'الكاشير والمالية الأساسية',
        items: [
          'نقطة بيع كاشير أساسية مع دعم الدفع النقدي والبطاقات',
          'إصدار فواتير مرقمة RC وحساب المتبقي وتصفية الطاولات فورياً',
          'مبيعات السفري والعميل المباشر (Walk-in Counter)',
        ],
      },
      {
        title: 'الدعم الفني والتشغيل',
        items: [
          'دعم فني فوري عبر واتساب في أوقات العمل (00970593498909)',
          'لوحة تحكم عربية واضحة وموثقة من منصة مريح',
        ],
      },
    ],
    cta: 'اشترك الآن',
  ...
  },
  {
    ...
    tagline: 'للمطاعم الفاخرة وقاعات الضيافة والمقاهي الكبيرة',
    priceMonthly: 349,
    priceYearly: 3490,
    priceYearlyPerMonth: Math.round(3490 / 12),
    features: [
      'حتى 50 طاولة مع تقسيم خرائط الصالات (زونات)',
      'شاشة مطبخ حية (KDS) بإشعارات صوتية ومؤقت زمن',
      'نقطة بيع POS متطورة وتصدير تقارير CSV',
      'تحليلات مبيعات متقدمة ومتوسط قيمة الطلب (AOV)',
      'تخصيص كامل للهوية: رفع الشعار والغلاف والألوان',
      'عروض وكومبو وطباعة بطاقات QR فوريّة',
    ],
    details: [
      {
        title: 'حدود السعة وإدارة الصالات',
        items: [
          'حتى 50 طاولة برموز QR فريدة (20 قسماً / 150 صنفاً)',
          'إدارة صالات متعددة (زونات): الصالة الرئيسية، التراس، VIP، والحديقة',
          'حسابات موظفين برموز PIN خاصة لكل دور (نادل/شيف/كاشير/مشرف)',
        ],
      },
      {
        title: 'شاشة المطبخ الحية (KDS)',
        items: [
          'وصول الطلبات فورياً للشيف بتنبيهات صوتية ومرئية لحظية',
          'عدّاد زمني ومؤقت لكل طلب مع حالات (جديد → قيد الطهي → جاهز للتقديم)',
          'قفل تعديل أو إلغاء الطلب بمجرد بدء التحضير لمنع الهدر',
        ],
      },
      {
        title: 'الهوية البصرية والتخصيص (Custom Branding)',
        items: [
          'رفع شعار مطعمك وصورة الغلاف مباشرة من لوحة التحكم',
          'اختيار طابع الألوان والتنسيقات الفاخرة لموقعك',
          'معاينة حية فورية لشكل الموقع كما يظهر على هاتف الزبون',
        ],
      },
      {
        title: 'التسويق والعروض والترويج',
        items: [
          'إنشاء عروض وجبات وتجميعات كومبو مع حساب التوفير تلقائياً',
          'إضافة شارات ترويجية للأطباق (جديد / الأكثر مبيعاً / مميز)',
        ],
      },
      {
        title: 'الكاشير والمالية والتحليلات',
        items: [
          'نقطة بيع POS متطورة مع طباعة ومشاركة الفاتورة عبر واتساب',
          'تحليلات مبيعات تفاعلية: إجمالي المبيعات، متوسط الطلب AOV، وساعات الذروة',
          'تصدير التقارير المالية والطلبات بصيغة CSV وتقرير فوري للطباعة',
        ],
      },
      {
        title: 'التشغيل اليومي والأمان',
        items: [
          'تصدير وطباعة بطاقات QR للطاولات بنماذج مفرودة ومقواة',
          'سجل تدقيق أمني كامل لكل عملية داخل النظام (Audit Log)',
          'أولويات استجابة لنداءات النادل من الجوال',
        ],
      },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'إدارة فروع متعددة (Multi-Branch) تحت حساب واحد',
      'نطاق مخصص لموقعك (Custom Domain)',
      'دعم فني وتدريب أولوية قصوى 24/7 من فريق مريح',
      'كل مزايا الباقة الاحترافية بالكامل',
    ],
    details: [
      {
        title: 'كل مزايا الباقة الاحترافية +',
        items: [
          'طاولات وأقسام وأطباق غير محدودة بدون أي رسوم إضافية (999+)',
          'حسابات موظفين ومديري فروع غير محدودين',
          'صلاحيات مستقلة ومديرو فروع لكل موقع على حدة',
        ],
      },
      {
        title: 'إدارة الفروع المتعددة (Multi-Branch System)',
        items: [
          'ربط وإدارة جميع فروع السلسلة من لوحة تحكم مركزية واحدة',
          'قوائم طعام وطاولات وأسعار مستقلة لكل فرع حسب موقعه',
          'تقارير مبيعات مفصلة لكل فرع على حدة مع مقارنة أداء الفروع',
        ],
      },
      {
        title: 'النطاق المخصص والهوية الكاملة',
        items: [
          'ربط المنيو بنطاقك الخاص (Custom Domain e.g. menu.yourrestaurant.com)',
          'تخصيص كامل وشامل للهوية البصرية على مستوى السلسلة الفندقية',
        ],
      },
      {
        title: 'الدعم والتدريب المخصص من مريح',
        items: [
          'دعم فني مباشر على مدار 24/7 بأولوية قصوى (00970593498909)',
          'جلسة تدريب وإعداد مجانية (Onboarding Session) لفريق عملك',
          'مدير حساب خاص واستشارات تشغيلية دورية لتطوير المبيعات',
        ],
      },
    ],
                  ...
                  <div className="p-6 sm:p-7 flex flex-col flex-1">
                    ...
                    <details
                      className={`group mb-5 rounded-xl border overflow-hidden transition-colors ${
                        isPro
                          ? 'border-[#0072BC]/40 bg-[#0072BC]/10'
                          : 'border-[#004B87]/40 bg-[#040D1A]/70'
                      }`}
                    >
                      <summary className="flex items-center justify-between gap-2 px-3.5 py-2.5 cursor-pointer list-none select-none">
                        <span className="text-[11px] font-bold text-slate-100 flex items-center gap-1.5">
                          <Crown
                            className={`w-3.5 h-3.5 ${isPro ? 'text-[#38BDF8]' : 'text-[#0072BC]'}`}
                          />
                      ...
                      <div className="px-3.5 pb-3.5 pt-1 space-y-3.5">
                        {plan.details.map((group) => (
                          <div key={group.title}>
                            <div
                              className={`text-[10px] font-black mb-1.5 flex items-center gap-1.5 ${
                                isPro ? 'text-[#38BDF8]' : 'text-slate-300'
                              }`}
                            >
                            ...
                            <ul className="space-y-1.5">
                              {group.items.map((item) => (
                                <li
                                  key={item}
                                  className="flex items-start gap-1.5 text-[10.5px] leading-relaxed text-slate-300"
                                >
