...
const PLAN_DETAIL_LINES: Record<string, string[]> = {
  'plan-starter': [
    'المنيو الرقمي بصور وتصنيفات (عربي/إنجليزي)',
    'طلب QR مباشر بدون تسجيل + تخصيص الطلب',
    'استدعاء النادل وطلبات متعددة بفاتورة مجمعة',
    'كاشير مع إيصالات RC وتصفية الطاولات',
    'حساب مدير + طاقم بلا حدود (دخول PIN)',
  ],
  'plan-pro': [
    'كل مزايا الأساسية + حتى 50 طاولة / 150 صنفاً',
    'شاشة مطبخ KDS حية بإشعارات لحظية',
    'تحليلات مبيعات (AOV) + تصدير CSV وتقرير فوري',
    'تخصيص الهوية: شعار وغطاء و7 طوابق ألوان ومعاينة حية',
    'عروض وكومبو + بطاقات QR قابلة للطباعة + فواتير واتساب',
    'نداءات أولوية وسجل تدقيق كامل',
  ],
  'plan-enterprise': [
    'كل مزايا Pro + طاولات وأصناف وفروع غير محدودة',
    'فروع متعددة بتقارير وطاولات وقوائم مستقلة',
    'نطاق مخصص (Custom Domain)',
    'دعم أولوية 24/7 + تدريب وإعداد مجاني',
  ],
};
