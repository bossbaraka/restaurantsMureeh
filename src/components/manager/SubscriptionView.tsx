...
// ميزات كل باقة بالتفصيل — لأغراض العرض ضمن نافذة الترقية (حدود صلبة + صلاحيات فعلية)
const PLAN_DETAIL_LINES: Record<string, string[]> = {
  'plan-starter': [
    'حتى 15 طاولة برموز QR فريدة + 6 أقسام و 35 صنفاً',
    'منيو رقمي فاخر بصور وأوصاف ومكونات (عربي/إنجليزي)',
    'طلب QR مباشر من الطاولة بدون تسجيل حساب للزبون',
    'خيارات التخصيص (إضافات، استبعاد مكونات، ملاحظات الشيف)',
    'استدعاء النادل مع تحديد السبب (مساعدة / طلب الفاتورة)',
    'كاشير أساسي لدفع الحساب نقداً/بطاقة وتصفية الطاولات',
    'حساب مدير + طاقم خدمة بدون حد (دخول PIN)',
    'دعم فني عبر واتساب في أوقات العمل من منصة مريح',
  ],
  'plan-pro': [
    'كل مزايا الباقة الأساسية بالكامل + حتى 50 طاولة / 150 صنفاً',
    'تقسيم وإدارة خرائط الصالات (رئيسية، تراس، VIP، حديقة)',
    'شاشة مطبخ حية (KDS) بإشعارات صوتية ومؤقت زمن للتحضير',
    'نقطة بيع POS متطورة لدعم السفري (Walk-in Counter)',
    'تحليلات مبيعات تفاعلية (AOV) + تصدير تقارير CSV',
    'تخصيص الهوية: رفع شعار وصورة غلاف وألوان ومعاينة حية',
    'عروض وكومبو + شارات ترويجية (جديد / مميز / الأكثر مبيعاً)',
    'تصدير وطباعة بطاقات QR للطاولات بنماذج مفرودة ومقواة',
    'نداءات النادل بالأولويات + سجل تدقيق كامل للعمليات',
  ],
  'plan-enterprise': [
    'كل مزايا الباقة الاحترافية + طاولات وأصناف وفروع غير محدودة (999+)',
    'إدارة الفروع المتعددة (Multi-Branch) من لوحة تحكم مركزية',
    'قوائم طعام وطاولات وأسعار وتقارير مبيعات مستقلة لكل فرع',
    'نطاق مخصص يظهر منيوك على رابطك الخاص (Custom Domain)',
    'حسابات موظفين ومديري فروع غير محدودين مع صلاحيات مستقلة',
    'دعم فني أولوية قصوى 24/7 + جلسة تدريب وإعداد (Onboarding) لفريقك',
  ],
};
